  ...
  return (
    <section className="hero-cine" aria-labelledby="heroTitle">
      <div className="hc-media">
        <div
          className="hc-photo hc-photo-air"
          role="img"
          aria-label="Charlottetown Taxi vehicle waiting at the Arrivals door of Charlottetown Airport YYG, Prince Edward Island"
        />
      ...
      <div className="wrap hc-inner">
        <p className="kicker fade" style={delayVar('.05s')}>
          ...
          Charlottetown Airport Taxi &middot; YYG
        </p>

        <h1 id="heroTitle" className="fade" style={delayVar('.15s')}>
          Charlottetown Airport transfers, <em>planned around your flight.</em>
        </h1>

        <p className="hc-lede fade" style={delayVar('.28s')}>
          Private transfers to and from Charlottetown Airport (YYG) with flight-tracked pickups,
          published airport fares and onward travel to every community on Prince Edward Island.
        </p>

        <p className="hc-line fade" style={delayVar('.38s')}>
          Land, walk out, and go.
        </p>
      ...
      <a className="hc-scroll fade" style={delayVar('.86s')} href="#fares">
        <span className="hcs-label">Airport fares below</span>
